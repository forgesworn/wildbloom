...
Wildbloom's production Web Crypto decryption. The branded Firefox acceptance
gate recovers the same published vector through the real retrieval journey.
The vector key is public test material and must never protect real content.
